// 1711から2010まで解析し2011から2015まで予想

public class Sunspots2 {
...
//		}
		...
		// 問題3(1)
		double mean=0;
		for(t=11;t<=310;t++) mean += x[t];
		mean /= 300;
		double normalX[] = new double[311];
		for(t=11;t<=310;t++){
			normalX[t] = x[t]-mean;
...
//			System.out.println(M + "\t" + AIC[M]);
		...
		/// 比較用オリジナルデータの表示(sunspots2005_2015.txtの表示)
		for(t=305 ; t<=315 ; t++){
